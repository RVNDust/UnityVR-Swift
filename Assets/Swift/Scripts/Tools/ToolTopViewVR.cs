...
{
    public class ToolTopViewVR : ToolBehaviour
    {
        ...
        {
            StartBehaviour();
            goRef.AddComponent<ToolTopViewVR>(); //Ajout du comportement spécifique sur le controller
        }

        public override void DesactivateTool(GameObject goRef)
        {
            Destroy(goRef.GetComponent<ToolTopViewVR>());
        }
